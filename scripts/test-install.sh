...
assert_shared_layout() {
  ...
  assert_dir "$repo/.agents/skills/security-review"
  assert_dir "$repo/.agents/skills/threat-model"
...
assert_claude_layout() {
  ...
  assert_dir "$repo/.claude/skills/security-review"
  assert_dir "$repo/.claude/skills/threat-model"
